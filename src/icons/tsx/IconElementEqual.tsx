  ...
  <IconStyled className={className}>
    {
      <svg
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M13.75 15.2846C13.75 14.8704 14.0858 14.5346 14.5 14.5346H20.5C20.9142 14.5346 21.25 14.8704 21.25 15.2846C21.25 15.6988 20.9142 16.0346 20.5 16.0346H14.5C14.0858 16.0346 13.75 15.6988 13.75 15.2846Z"
          fill="currentColor"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M13.75 19.7846C13.75 19.3704 14.0858 19.0346 14.5 19.0346H20.5C20.9142 19.0346 21.25 19.3704 21.25 19.7846C21.25 20.1988 20.9142 20.5346 20.5 20.5346H14.5C14.0858 20.5346 13.75 20.1988 13.75 19.7846Z"
          fill="currentColor"
        />
      </svg>
    }
