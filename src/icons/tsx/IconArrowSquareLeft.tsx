  ...
  <IconStyled className={className}>
    {
      <svg
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M14.5303 17.5303C14.2374 17.8232 13.7626 17.8232 13.4697 17.5303L9.88388 13.9445C8.80994 12.8706 8.80994 11.1294 9.88388 10.0555L13.4697 6.46967C13.7626 6.17678 14.2374 6.17678 14.5303 6.46967C14.8232 6.76256 14.8232 7.23744 14.5303 7.53033L10.9445 11.1161C10.4564 11.6043 10.4564 12.3957 10.9445 12.8839L14.5303 16.4697C14.8232 16.7626 14.8232 17.2374 14.5303 17.5303Z"
          fill="currentColor"
        />
        <path
