  ...
  <IconStyled className={className}>
    {
      <svg
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M18 7.5C18.8284 7.5 19.5 6.82843 19.5 6C19.5 5.17157 18.8284 4.5 18 4.5C17.1716 4.5 16.5 5.17157 16.5 6C16.5 6.82843 17.1716 7.5 18 7.5Z"
          fill="currentColor"
        />
      </svg>
    }
...
export default IconMenuBentoClassic;
